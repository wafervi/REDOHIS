        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="guarda.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="nombre" class="form-label">Asunto del documento:</label>
                    ...
                    <div class="mb-3">
                        <label for="genero" class="form-label">Estado del documento:</label>
                    ...
                    <div class="mb-3">
                        <label for="poster" class="form-label">Adjuntar soporte:</label>
